...
TEST(RewardTests, rewardFalloffTest) {
  // BASIC DIRECT HITS
  {
    ...
    Reward r1(100, Reward::RewardType::TRIVIAL);
    Reward r2(100, Reward::RewardType::DISTANCE);
    Reward r3(100, Reward::RewardType::DIST_TIME);
  ...
  // HITS OUTSIDE DEADZONE RADIUS
  {
    ...
    EXPECT_EQ(0, r1.value_from_location(qloc2, rloc));
    EXPECT_EQ(0, r2.value_from_location(qloc2, rloc));
    EXPECT_EQ(0, r3.value_from_location(qloc2, rloc));
  }
  ...
  // HITS ON EDGE
  {
    ...
    Reward r1(100, Reward::RewardType::TRIVIAL);
    Reward r2(1, Reward::RewardType::TRIVIAL);
