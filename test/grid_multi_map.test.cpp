...
TEST(GridMultiMap, findLocations) {
  //small
  ...
  expected_result = { { m3, 922 }, { m3, 922 }, { m3, 922 }, { m3, 922 }, { m3, 922 }, { m5, 923 }, { m6, 932 }, { l3, 933 } };
  EXPECT_TRUE(areEqual(expected_result, ret));

  gridmap.erase_one(m3, 922);
  ret = gridmap.find(m3, l3);
  expected_result = { { m3, 922 }, { m3, 922 }, { m3, 922 }, { m3, 922 }, { m5, 923 }, { m6, 932 }, { l3, 933 } };
  EXPECT_TRUE(areEqual(expected_result, ret));

  gridmap.erase_all(m3, 922);
  ret = gridmap.find(m3, l3);
  expected_result = { { m5, 923 }, { m6, 932 }, { l3, 933 } };
  EXPECT_TRUE(areEqual(expected_result, ret));

  std::string test = "test";
  GridMultiMap<std::string> grid_map_str;
